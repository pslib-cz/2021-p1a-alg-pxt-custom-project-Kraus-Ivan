...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (mec == true) {
        if (pozice_zbrane[0] == 1) {
            projectileUP = sprites.createProjectileFromSprite(assets.image`projectileUP`, mySprite, 0, -100)
            animation.runImageAnimation(
            mySprite,
            ...
            pause(200)
            projectileUP.destroy()
        } else if (pozice_zbrane[1] == 1) {
            projectileDOWN = sprites.createProjectileFromSprite(assets.image`sword effect`, mySprite, 0, 100)
            animation.runImageAnimation(
            mySprite,
            [img`
                ........................
            ...
            pause(200)
            projectileDOWN.destroy()
        } else if (pozice_zbrane[2] == 1) {
            projectileLEFT = sprites.createProjectileFromSprite(assets.image`projectileLEFT`, mySprite, -100, 0)
            animation.runImageAnimation(
            mySprite,
            [img`
                ........................
            ...
            pause(200)
            projectileLEFT.destroy()
        } else {
            projectileRIGHT = sprites.createProjectileFromSprite(assets.image`projectileRIGHT`, mySprite, 100, 0)
            animation.runImageAnimation(
            mySprite,
            [img`
                ........................
...
function level3 () {
    ...
    for (let index = 0; index <= 18; index++) {
        spoustec = sprites.create(img`
            6 
            `, SpriteKind.spoustec)
        tiles.placeOnTile(spoustec, tiles.getTileLocation(37, index + 1))
    }
...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.enemyTree, function (sprite, otherSprite) {
    ...
    [img`
        ...
        ....f8ffff8fffffffff....
        ..f66686666666866668668.
        .f8866686686866686668fff
        f88ff8ff88ffff88ffff8...
        ffff88f88ffffff8f8ff88..
        f668666866f666868666866f
        ......fff8fff88ffff.....
        .........ffeeff.........
        ...
        ...88778868678688776....
        ..8777767767787767778...
        .8777677777776777767788.
        ..887766768668776667668.
        ..8688668886688686688668
        866886886688886688888888
        88886686688888868688668.
        .8688888888888888668868.
        .8878888868868878868788.
        877677767787776767776778
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.spoustec, function (sprite, otherSprite) {
    if (currentLevel == 3 && dialogSkoncen2 == true) {
...
sprites.onOverlap(SpriteKind.NPC, SpriteKind.Player, function (sprite, otherSprite) {
    ...
    if (dialogSkoncen2 == false) {
        ...
        game.showLongText("JÁ:  To ti tak budu věřit...", DialogLayout.Bottom)
        dialogSkoncen2 = true
    }
})
...
let randomPozice: tiles.Location = null
...
game.onUpdateInterval(5000, function () {
    if (currentLevel == 3 && mec == true) {
        randomPozice = tiles.getTilesByType(assets.tile`myTile9`)._pickRandom()
        myEnemy = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Enemy)
        tiles.placeOnTile(myEnemy, randomPozice)
